...
public class Classteacheratten extends AppCompatActivity {
...
//        });
    ...
    private void opencalender() {
        new DatePickerDialog(Classteacheratten.this, R.style.DialogTheme, dateSetListener, myCalendar
                .get(Calendar.YEAR),
            ...
            builder.setMessage("You have no Permission Attendance on this date..!!")
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            startActivity(new Intent(Classteacheratten.this, MainMenuActivity.class));
                            finish();
                        }
...
//        pDialog.show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Classteacheratten.this);
