...
public class ParentAdapter extends ArrayAdapter<GiveHomeworkDataModel> implements View.OnClickListener {
...
//        ImageView open_camera;
    ...
    public ParentAdapter(ArrayList<GiveHomeworkDataModel> data, Context context) {
...
//                        Intent intent = new Intent(mContext,parenteacheratten.class);
