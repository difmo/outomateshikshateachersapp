...
public class Parent_module extends AppCompatActivity {
    ...
    private ParentAdapter customListAdapter;
    @Override
...
//        });
    ...
    private void opencalender() {
        new DatePickerDialog(Parent_module.this, R.style.DialogTheme, dateSetListener, myCalendar
                .get(Calendar.YEAR),
            ...
            builder.setMessage("You have no Permission Attendance on this date..!!")
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            startActivity(new Intent(Parent_module.this, MainMenuActivity.class));
                            finish();
                        }
...
//        pDialog.show();
        ...
        String url = Url_Symbol.url + "CTAttendance_timetable/teacherid/" + Stuid + "/branchid/" + branchid + "/date/" + Date;
        Log.e("homeworkURL", url);
        RequestQueue requestQueue = Volley.newRequestQueue(Parent_module.this);
...
//                Log.e("subject", cursor.getString(1));
        ...
        customListAdapter = new ParentAdapter(userInfos, this);
