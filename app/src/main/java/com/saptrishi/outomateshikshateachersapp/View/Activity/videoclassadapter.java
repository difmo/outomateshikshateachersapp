...
public class videoclassadapter  extends ArrayAdapter<TimeTableDataModel> implements View.OnClickListener {
    ...
    public videoclassadapter(ArrayList<TimeTableDataModel> data, Context context) {
