...
public class Classwork_Activity extends AppCompatActivity {
    ...
    private Classwork_Adapter customListAdapter;
...
//        });
    ...
    private void opencalender() {
        new DatePickerDialog(Classwork_Activity.this, R.style.DialogTheme, dateSetListener, myCalendar
                .get(Calendar.YEAR),
            ...
            builder.setMessage("You have no class on this date..!!")
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            startActivity(new Intent(Classwork_Activity.this, MainMenuActivity.class));
                            finish();
                        }
...
//        pDialog.show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Classwork_Activity.this);
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        if (ermsg.equals("Correct")) {
                            ...
                            editor.putString("branchidd",branchid);
                            editor.apply();
...
//userInfos.add(new GiveHomeworkDataModel(jsonObject.getString("ClassNm"), jsonObject.getString("Period_Name"), jsonObject.getString("SubjectName")));
                            ...
                            builder.setMessage("You have Class for this date..!!")
                                    .setCancelable(false)
                                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            startActivity(new Intent(Classwork_Activity.this, MainMenuActivity.class));
...
//                pDialog.hide();
                if (error.networkResponse == null) {
                    if (error.getClass().equals(TimeoutError.class)) {
                       ...
                       Toast toast= Toast.makeText(Classwork_Activity.this, "Try Again!", Toast.LENGTH_SHORT);
...
//                Log.e("subject", cursor.getString(1));
        ...
        customListAdapter = new Classwork_Adapter(userInfos, this);
