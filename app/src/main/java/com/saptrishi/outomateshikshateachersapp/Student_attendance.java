...
//                Log.e("sssss","aaaa"+s);
                if (!Connectivity.isConnected(Student_attendance.this)) {
                    Sending_AttendenceToDB sending_attendenceToDB = new Sending_AttendenceToDB(Student_attendance.this);
...
////                            senddatatovolley(clsstrucid.get(i),AttendenceAdapter.st_id.get(i).getStudentID(),SubjectID_FK.get(i),"A",TeacherID_FK.get(i),currentDate,localTime,branchid,SessionID.get(i));
                            sending_attendenceToDB.senddatatovolley(clsstrucid_send, AttendenceAdapter.st_id.get(i).getStudentID(), subj, "P", finalTeacherID_FK, dkdate, localTime, branchid, SessionID.get(i), AttendenceAdapter.st_id.get(i).getAttDesc());// change 27 nov
//
//
...
////                        sqliteDataBase.deleteattendancetable()
                            ...
                            sending_attendenceToDB.senddatatovolley(clsstrucid_send, AttendenceAdapter.st_id.get(i).getStudentID(),
                                    subj, "A",TeacherID_FK_send, dkdate, localTime, branchid, SessionID.get(i), AttendenceAdapter.st_id.get(i).getAttDesc());// change 27 nov
...
////                            senddatatovolley(clsstrucid.get(i),AttendenceAdapter.st_id.get(i).getStudentID(),SubjectID_FK.get(i),"A",TeacherID_FK.get(i),currentDate,localTime,branchid,SessionID.get(i));
                            sqliteDataBase.attendenceinsertion(clsstrucid_send, AttendenceAdapter.st_id.get(i).getStudentID(), subj, "P", finalTeacherID_FK, dkdate, localTime, branchid, SessionID.get(i), AttendenceAdapter.st_id.get(i).getAttDesc());//change 27
                        }
                        else
                        {
                            ...
                            Log.e("Unselected12", branchid);
                            Log.e("Unselected12", SessionID.get(i));
                            Log.e("Unselected13","a:"+ AttendenceAdapter.st_id.get(i).getAttDesc());
////                           sqliteDataBase.deleteattendancetable()
//                            AttendenceAdapter.st_id.get(i).getAttDesc() put Here desc
                            ...
                            sqliteDataBase.attendenceinsertion(clsstrucid_send, AttendenceAdapter.st_id.get(i).getStudentID(), subj, "A", finalTeacherID_FK, dkdate, localTime, branchid, SessionID.get(i), AttendenceAdapter.st_id.get(i).getAttDesc()); // change 27 SubjectID_FK_send
                        }
                    }

                }
                Toast.makeText(Student_attendance.this, "Attendance Saved", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Student_attendance.this, MainMenuActivity.class));
                finish();
            }
        });
...
//          String classid=intent.getStringExtra("class");class
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                AttendenceAdapter attendenceAdapter = new AttendenceAdapter(Student_attendance.this, student_name, student_id, stu_id, stu_img, status);
                ...
                checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        ...
                        if (isChecked == true) {
                            stu_id = getModel(true);
                            AttendenceAdapter attendenceAdapter1 = new AttendenceAdapter(Student_attendance.this, student_name, student_id, stu_id, stu_img, status);//stu_id
                            Toast.makeText(Student_attendance.this, "Present", Toast.LENGTH_LONG).show();
                            listView.setAdapter(attendenceAdapter1);
                        } else {
                            stu_id = getModel(false);
                            AttendenceAdapter attendenceAdapter2 = new AttendenceAdapter(Student_attendance.this, student_name, student_id, stu_id, stu_img, status);
