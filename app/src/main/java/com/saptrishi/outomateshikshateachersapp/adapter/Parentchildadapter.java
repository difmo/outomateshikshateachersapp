...
public class Parentchildadapter extends BaseAdapter {
    ...
    public Parentchildadapter(Context context, List<String> stu_name, List<String> stu_id, List<Model> st_id, List<String> stu_img, List<String> stu_status) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.parentchildlist, null, true);
